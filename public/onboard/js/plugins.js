...
function createBullets() {
    for (var i = 0; i < numOfSlides + 1; i++) {
        var e = $("<li class='slider-pagi__elem'></li>");
        (e.addClass("slider-pagi__elem-" + i).data("page", i),
            i || e.addClass("active"),
            $pagination.append(e));
    }
}
...
function autoSlide() {
    autoSlideTimeout = setTimeout(function () {
        (numOfSlides < ++curSlide && (curSlide = 0), changeSlides());
    }, autoSlideDelay);
}
...
function navigateLeft() {
    animating || (0 < curSlide && curSlide--, changeSlides());
}
...
(createBullets(),
    autoSlide(),
    $(document).on("mousedown touchstart", ".slider", function (i) {
        if (!animating) {
            window.clearTimeout(autoSlideTimeout);
            var a = i.pageX || i.originalEvent.touches[0].pageX,
                d = $(window).width();
            ((diff = 0),
                $(document).on("mousemove touchmove", function (i) {
                    var e = i.pageX || i.originalEvent.touches[0].pageX;
                    ((diff = ((a - e) / d) * 70),
                        ((!curSlide && diff < 0) ||
                            (curSlide === numOfSlides && 0 < diff)) &&
                            (diff /= 2),
                        $slider.css(
                            "transform",
                            "translate3d(" +
    ...
    $(document).on("mouseup touchend", function (i) {
    ...
    function n(e, t, o) {
        if ((p(t, o), 1 != z.accelerationMax)) {
            ...
            if (r < z.accelerationDelta) {
                var a = (1 + 50 / r) / 2;
                a > 1 &&
                    ((a = Math.min(a, z.accelerationMax)), (t *= a), (o *= a));
            }
            R = Date.now();
        }
        if (
...
!(function (a, b) {
    ...
    function o(b) {
        (n(this, b),
            ...
            Ud === !1 && ((Ud = !0), a.updateOffset(this), (Ud = !1)));
    }
    function p(a) {
    ...
    function w(a) {
        var b = null;
        if (!Vd[a] && "undefined" != typeof module && module && module.exports)
            try {
    ...
    function M(a, b) {
        return a.isValid()
            ? ((b = N(b, a.localeData())), (Zd[b] = Zd[b] || L(b)), Zd[b](a))
    ...
    function N(a, b) {
        ...
        var d = 5;
        for (Yd.lastIndex = 0; d >= 0 && Yd.test(a); )
            ((a = a.replace(Yd, c)), (Yd.lastIndex = 0), (d -= 1));
        return a;
    }
    function O(a, b, c) {
        qe[a] = D(b)
    ...
    function W(a, b) {
        return c(this._months)
            ...
            : this._months[Be.test(b) ? "format" : "standalone"][a.month()];
    }
    function X(a, b) {
        return c(this._monthsShort)
            ? this._monthsShort[a.month()]
            : this._monthsShort[Be.test(b) ? "format" : "standalone"][
                  a.month()
              ];
    }
    function Y(a, b, c) {
        ...
        return (
            c &&
                ...
                ((b =
                    c[te] < 0 || c[te] > 11
                        ? te
                        : c[ue] < 1 || c[ue] > V(c[se], c[te])
                          ? ue
                          : c[ve] < 0 ||
                              c[ve] > 24 ||
                              (24 === c[ve] &&
                                  (0 !== c[we] || 0 !== c[xe] || 0 !== c[ye]))
                            ? ve
                            : c[we] < 0 || c[we] > 59
                              ? we
                              : c[xe] < 0 || c[xe] > 59
                                ...
                                : c[ye] < 0 || c[ye] > 999
                                  ? ye
                                  : -1),
                j(a)._overflowDayOfYear && (se > b || b > ue) && (b = ue),
                j(a)._overflowWeeks && -1 === b && (b = ze),
                j(a)._overflowWeekday && -1 === b && (b = Ae),
                (j(a).overflow = b)),
            a
        );
    }
    ...
    function ua(a) {
        ...
        if (!a._d) {
            for (
                d = ta(a),
                    a._w && null == a._a[ue] && null == a._a[te] && va(a),
                    a._dayOfYear &&
                        ((e = sa(a._a[se], d[se])),
                        a._dayOfYear > la(e) && (j(a)._overflowDayOfYear = !0),
                        (c = ka(e, 0, a._dayOfYear)),
                        (a._a[te] = c.getUTCMonth()),
                        (a._a[ue] = c.getUTCDate())),
                    b = 0;
                3 > b && null == a._a[b];
                ++b
            )
            ...
            (24 === a._a[ve] &&
                ...
                0 === a._a[xe] &&
                0 === a._a[ye] &&
                ((a._nextDay = !0), (a._a[ve] = 0)),
                (a._d = (a._useUTC ? ka : ja).apply(null, f)),
                null != a._tzm &&
                    a._d.setUTCMinutes(a._d.getUTCMinutes() - a._tzm),
                a._nextDay && (a._a[ve] = 24));
        }
    }
    function va(a) {
        var b, c, d, e, f, g, h, i;
        ((b = a._w),
            null != b.GG || null != b.W || null != b.E
                ? ((f = 1),
                  (g = 4),
                  (c = sa(b.GG, a._a[se], qa(Ea(), 1, 4).year)),
                  (d = sa(b.W, 1)),
                  (e = sa(b.E, 1)),
                  (1 > e || e > 7) && (i = !0))
                : ((f = a._locale._week.dow),
                  (g = a._locale._week.doy),
                  (c = sa(b.gg, a._a[se], qa(Ea(), f, g).year)),
                  (d = sa(b.w, 1)),
                  null != b.d
                      ? ((e = b.d), (0 > e || e > 6) && (i = !0))
                      : null != b.e
    ...
    function wa(b) {
        ...
        var c,
            ...
            i = h.length,
            k = 0;
        for (e = N(b._f, b._locale).match(Xd) || [], c = 0; c < e.length; c++)
            ((f = e[c]),
                (d = (h.match(P(f, b)) || [])[0]),
                d &&
        ...
        ((j(b).charsLeftOver = i - k),
            ...
            j(b).bigHour === !0 &&
                ...
                b._a[ve] > 0 &&
                (j(b).bigHour = void 0),
            (b._a[ve] = xa(b._locale, b._a[ve], b._meridiem)),
            ua(b),
            da(b));
    }
    function xa(a, b, c) {
    ...
    function Sa() {
        return (
            this._tzm
                ...
                : "string" == typeof this._i && this.utcOffset(La(me, this._i)),
            this
        );
    }
    function Ta(a) {
        return this.isValid()
            ? ((a = a ? Ea(a).utcOffset() : 0),
    ...
    function Bc() {
        var a = this._data;
        return (
            (this._milliseconds = qf(this._milliseconds)),
            (this._days = qf(this._days)),
            (this._months = qf(this._months)),
            (a.milliseconds = qf(a.milliseconds)),
            (a.seconds = qf(a.seconds)),
            (a.minutes = qf(a.minutes)),
            (a.hours = qf(a.hours)),
            (a.months = qf(a.months)),
            (a.years = qf(a.years)),
            this
        );
    }
    ...
    function ud(a, b, c, d) {
        ...
        return 1 === a
            ? e + rd(a, b, c[0], d)
            : b
              ? e + (sd(a) ? td(c)[1] : td(c)[0])
              : d
                ? e + td(c)[1]
                : e + (sd(a) ? td(c)[1] : td(c)[2]);
    }
    function vd(a, b, c) {
        return c
            ? b % 10 === 1 && 11 !== b
    ...
    ((gf.add = Ue),
        ...
        (gf.daysInMonth = _),
        (gf.week = gf.weeks = Tb),
        (gf.isoWeek = gf.isoWeeks = Ub),
        (gf.weeksInYear = Mb),
        (gf.isoWeeksInYear = Lb),
        (gf.date = Ye),
        (gf.day = gf.days = $b),
        (gf.weekday = _b),
        (gf.isoWeekday = ac),
        ...
        (gf.zoneAbbr = ic),
        (gf.zoneName = jc),
        (gf.dates = fa("dates accessor is deprecated. Use date instead.", Ye)),
        (gf.months = fa("months accessor is deprecated. Use month instead", $)),
        (gf.years = fa("years accessor is deprecated. Use year instead", Ne)),
        (gf.zone = fa(
    ...
    ((pf._calendar = jf),
        (pf.calendar = mc),
        (pf._longDateFormat = kf),
        (pf.longDateFormat = nc),
        (pf._invalidDate = lf),
        (pf.invalidDate = oc),
        (pf._ordinal = mf),
        (pf.ordinal = pc),
        ...
        (pf._monthsRegex = Fe),
        (pf.monthsRegex = ba),
        (pf._monthsShortRegex = Ee),
        (pf.monthsShortRegex = aa),
        (pf.week = Qb),
        (pf._week = Xe),
        (pf.firstDayOfYear = Sb),
        (pf.firstDayOfWeek = Rb),
        (pf.weekdays = Wb),
        (pf._weekdays = Ze),
        (pf.weekdaysMin = Yb),
        (pf._weekdaysMin = _e),
                ...
                translate: function (a, b, c) {
                    ...
                    return 1 === c.length
                        ? b
                            ? d[0]
                            : d[1]
                        : a + " " + tg.correctGrammaticalCase(a, d);
                },
            }),
        ug =
            (Kf.defineLocale("me", {
            ...
            Kf.defineLocale("ml", {
                ...
                isPM: function (a) {
                    return /^(ഉച്ചകഴിഞ്ഞ്|വൈകുന്നേരം|രാത്രി)$/.test(a);
                },
                meridiem: function (a, b, c) {
                    return 4 > a
                        ? "രാത്രി"
                ...
                translate: function (a, b, c) {
                    ...
                    return 1 === c.length
                        ? b
                            ? d[0]
                            : d[1]
                        : a + " " + Hg.correctGrammaticalCase(a, d);
                },
            }),
        Ig =
            (Kf.defineLocale("sr-cyrl", {
                months: [
                    "јануар",
                    "фебруар",
                    "март",
                ...
                translate: function (a, b, c) {
                    ...
                    return 1 === c.length
                        ? b
                            ? d[0]
                            : d[1]
                        : a + " " + Ig.correctGrammaticalCase(a, d);
                },
            }),
        Jg =
            (Kf.defineLocale("sr", {
...
!(function (e) {
    ...
    var n = function (n, a) {
        var r,
            ...
            x = function (e) {
                ...
                return (
                    ...
                    void 0 === e || null === e
                        ? (n = d
                              ? t().tz(a.timeZone).startOf("d")
                              : t().startOf("d"))
                        : d
                          ? ((r = t().tz(a.timeZone).utcOffset()),
                            (i = t(e, l, a.useStrict).utcOffset()),
                            i !== r
                                ? ((o = t().tz(a.timeZone).format("Z")),
                                  (s =
                                      t(e, l, a.useStrict).format(
                                          "YYYY-MM-DD[T]HH:mm:ss",
                                      ) + o),
                                  (n = t(s, l, a.useStrict).tz(a.timeZone)))
                                : (n = t(e, l, a.useStrict).tz(a.timeZone)))
                          : (n = t(e, l, a.useStrict)),
                    n
                );
            },
            ...
            H = function () {
                var t = e("<div>").addClass(
                    ...
                    r = e("<div>").addClass("timepicker").append(P()),
                ...
                if (
                    ...
                    if (
                        (e.each(a.disabledTimeIntervals, function () {
                            return t.isBetween(this[0], this[1])
                                ? ((r = !0), !1)
                                : void 0;
                        }),
                        r)
            ...
            U = function () {
                var e = m.find(".datepicker-decades"),
                    n = e.find("th"),
                    ...
                    l = "";
                for (
                    n.eq(0).find("span").attr("title", a.tooltips.prevCentury),
                        n
                            .eq(2)
                            .find("span")
                        ...
                        e.find(".disabled").removeClass("disabled"),
                        (o.isSame(t({ y: 1900 })) ||
                            (a.minDate && a.minDate.isAfter(o, "y"))) &&
                            n.eq(0).addClass("disabled"),
                        n.eq(1).text(o.year() + "-" + s.year()),
                        (o.isSame(t({ y: 2e3 })) ||
                            (a.maxDate && a.maxDate.isBefore(s, "y"))) &&
                            n.eq(2).addClass("disabled");
                    !o.isAfter(s, "y");
                )
                    ((l +=
                ...
                if (M()) {
                    for (
                        ...
                        (0 === t.weekday() &&
                            ...
                            p.push(n)),
                            (o = ""),
                            t.isBefore(i, "M") && (o += " old"),
                            t.isAfter(i, "M") && (o += " new"),
                            t.isSame(r, "d") && !u && (o += " active"),
                            N(t, "d") || (o += " disabled"),
                            t.isSame(x(), "d") && (o += " today"),
                            (0 === t.day() || 6 === t.day()) &&
                                (o += " weekend"),
                            n.append(
                ...
                return e
                    ? ((e = e.clone().locale(a.locale)),
                      ...
                      void (N(e)
                          ...
                          : (a.keepInvalid || o.val(u ? "" : r.format(d)),
                            q({ type: "dp.error", date: e }))))
                    : ((u = !0),
                      o.val(""),
                      n.data("date", ""),
            ...
            ne = {
                ...
                togglePicker: function (t) {
                    ...
                    if (o && o.length) {
                        if (((n = o.data("collapse")), n && n.transitioning))
                            return;
                        (o.collapse
            ...
            ae = function (t) {
                return e(t.currentTarget).is(".disabled")
                    ? !1
                    : (ne[e(t.currentTarget).data("action")].apply(
                          c,
                          arguments,
                      ),
                      !1);
        ...
        if (
            ...
            o = n;
        else if (((o = n.find(a.datepickerInput)), 0 === o.size()))
            o = n.find("input");
        else if (!o.is("input"))
            throw new Error(
                'CSS class "' +
        ...
        if (
            (n.hasClass("input-group") &&
                (f =
                    0 === n.find(".datepickerbutton").size()
...
!(function (t, i) {
    ...
    function J(t) {
        return (
            V(t, "mousedown touchstart dblclick", Y),
            G(t, "click", et),
            this
        );
    }
    ...
    var hi = {
        ...
        removeEventParent: function (t) {
            return (
                this._eventParents && delete this._eventParents[n(t)],
                this
            );
        },
    ...
    var Ve = Ue.extend({
        ...
        $e = Je.extend({
            ...
            setStyle: function (t) {
                ...
                return (
                    Je.prototype.setStyle.call(this, t),
                    this.setRadius(i),
                    this
                );
            },
    ...
    var ln = hn.extend({
        ...
        getEvents: function () {
            var t = hn.prototype.getEvents.call(this);
            return (
                Vi && !this.options.permanent && (t.preclick = this._close),
                t
            );
        },
        _close: function () {
